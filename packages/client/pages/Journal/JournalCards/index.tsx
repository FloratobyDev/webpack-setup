...
function JournalCards() {
  ...
  useEffect(() => {
    // console.log("activeTab", activeTab, bookmarks, journals);

    setActiveValues(getActiveValues());
  }, [activeTab, bookmarks, journals]);

  // console.log("active", activeValues);

  const modifiedActiveValues = useMemo(() => {
          ...
          {modifiedActiveValues.map((value) => (
            ...
            >
              <div className="flex items-center">
                <button onClick={handleAddBookmark(value)}>
                  <svg
                    fill="none"
                    height="14"
                    viewBox="0 0 14 14"
